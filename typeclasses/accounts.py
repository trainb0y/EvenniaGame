...
class Account(DefaultAccount):
    ...
    * Hook methods (when re-implementation, remember methods need to have self as first arg)
    ...
    """
    '''
    def at_account_creation(self):  # The problem is at this point there is no self.character when this is run
        evmenu.EvMenu(self.character,
                    "typeclasses.charactercreation",
                    startnode="menunode_racelist")
        self.character.setup() # Set up statistics and such
    def at_first_login() # has no self argument 
    '''
